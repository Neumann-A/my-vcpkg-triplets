...
# Set compiler.
file(TO_CMAKE_PATH "$ENV{ProgramFiles}/LLVM" USED_LLVM_ROOT)

list(INSERT CMAKE_PROGRAM_PATH 0 "${USED_LLVM_ROOT}/bin")
set(CMAKE_C_COMPILER "${USED_LLVM_ROOT}/bin/clang-cl.exe" CACHE STRING "" FORCE)
set(CMAKE_CXX_COMPILER "${USED_LLVM_ROOT}/bin/clang-cl.exe" CACHE STRING "" FORCE)
set(CMAKE_AR "${USED_LLVM_ROOT}/bin/llvm-lib.exe" CACHE STRING "" FORCE)
set(CMAKE_LINKER "${USED_LLVM_ROOT}/bin/lld-link.exe" CACHE STRING "" FORCE)
